...
#   --$4.20 per $100 or vehicle value (4.20% per year)
#   --paid every six months
# Personal Property. Tax Relief (PPTR):
#   -- Eligibility:Owned or leased vehicles which are predominately used for non-business purposes & have passgenger license plates
...
def display_results():
    ...
    print("\n\t tRUN DATE/ TIME: "+ str (datetime.datetime.now()))
